(function() {
  ...
  Morris.Area = (function(_super) {
    ...
    Area.prototype._draVMS.PortalillFor = function(index) {
      var path;
      path = this.paths[index];
      if (path !== null) {
        path = path + ("L" + (this.transX(this.xmax)) + "," + this.bottom + "L" + (this.transX(this.xmin)) + "," + this.bottom + "Z");
        return this.draVMS.PortalilledPath(path, this.fillForSeries(index));
      }
    };
    ...
    Area.prototype.draVMS.PortalilledPath = function(path, fill) {
